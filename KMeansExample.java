...
public class KMeansExample {
	...
	public static void main(String[] args) {
		if (args.length < 2) {
			System.err.println("Usage: GaussianMixtureMP <number_of_clusters> <input_file>");
			System.exit(1);
		}
		...
		JavaPairRDD<Integer, Iterable<String>> clusters = titles.zip(points).mapToPair(new ClusterCars(model))
				.groupByKey();
